...
<div class="space-y-6">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Configuración del Sistema de Correo</h2>
    </div>
            @if (session('success'))
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="mb-6">
                        <h3 class="text-lg font-semibold mb-2">Configuración SMTP</h3>
                        <p class="text-gray-600 dark:text-gray-400">
                            Configure los detalles del servidor SMTP para el envío de correos automáticos desde la plataforma.
                            Esta configuración afecta a todo el sistema.
                        </p>
                    </div>
